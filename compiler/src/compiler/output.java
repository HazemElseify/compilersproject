...
public class output extends javax.swing.JFrame {
    ...
    public output(ArrayList<TokenData> list){
       initComponents();
       DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
for (int i = 0; i < list.size(); i++) {
        Vector<Object> data = new Vector<Object>();
      data.add(list.get(i).lineNo);
      data.add(list.get(i).lex);
      data.add(list.get(i).Ret);
      data.add(list.get(i).LexNoInLine);
      data.add(list.get(i).Match);
        model.addRow(data);
    }
    ...
    private void initComponents() {
        ...
        jTable1.setBackground(new java.awt.Color(0, 65, 86));
        jTable1.setFont(new java.awt.Font("Yu Gothic UI Light", 1, 14)); // NOI18N
        jTable1.setForeground(new java.awt.Color(254, 216, 118));
        ...
        jTable1.setSelectionForeground(new java.awt.Color(57, 57, 57));
        jScrollPane1.setViewportView(jTable1);

        jLabel2.setFont(new java.awt.Font("Goudy Stout", 3, 36)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(254, 216, 118));
        jLabel2.setText("SCANNER OUTPUT");
        jLabel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(254, 216, 118), 4));
